...
class Buy(Resource):
    ...
    def parseRequest():
        ...
        parser.add_argument("sell_in", type=str, required=True, help="item sell_in required")
        parser.add_argument("quality", type=str, required=True, help="item quality required")
